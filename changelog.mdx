...
## <code className="font-mono text-xs bg-black/[0.02] w-fit border text-primary-foreground block">June 15, 2025</code>
<p className="text-xl font-semibold text-primary leading-tight mt-1 mb-2">CDP Template Support & UI Refresh</p>
...
## <code className="font-mono text-xs bg-black/[0.02] w-fit border text-primary-foreground block">June 8, 2025</code>
<p className="text-xl font-semibold text-primary leading-tight mt-1 mb-2">Chat improvements and PDF viewer</p>
...
## <code className="font-mono text-xs bg-black/[0.02] w-fit border text-primary-foreground block">June 1, 2025</code>
<p className="text-xl font-semibold text-primary leading-tight mt-1 mb-2">Excel functions</p>
...
## <code className="font-mono text-xs bg-black/[0.02] w-fit border text-primary-foreground block">May 11, 2025</code>
<p className="text-xl font-semibold text-primary leading-tight mt-1 mb-2">Answer Library</p>
...
## <code className="font-mono text-xs bg-black/[0.02] w-fit border text-primary-foreground block">February 24, 2025</code>
<p className="text-xl font-semibold text-primary leading-tight mt-1 mb-2">Automate answering directly in Word and Outlook</p>
...
*PDF and online portals are coming soon.*

---

## <code className="font-mono text-xs bg-black/[0.02] w-fit border text-primary-foreground block">February 13, 2025</code>
<p className="text-xl font-semibold text-primary leading-tight mt-1 mb-2">Shared Workspaces</p>
...
## <code className="font-mono text-xs bg-black/[0.02] w-fit border text-primary-foreground block">October 13, 2024</code>
<p className="text-xl font-semibold text-primary leading-tight mt-1 mb-2">Auto-tag sources</p>
...
## <code className="font-mono text-xs bg-black/[0.02] w-fit border text-primary-foreground block">September 10, 2024</code>
<p className="text-xl font-semibold text-primary leading-tight mt-1 mb-2">Export your questionnaire to Excel</p>
...
## <code className="font-mono text-xs bg-black/[0.02] w-fit border text-primary-foreground block">August 20, 2024</code>
<p className="text-xl font-semibold text-primary leading-tight mt-1 mb-2">Enhanced suggestion reviews and Excel export</p>
...
- [Follow on Twitter](https://twitter.com/passionfruit) 