...
<div className="bg-[#FDFDFD] rounded-lg flex items-center justify-center overflow-hidden outline-[0.5px] outline outline-black/10">
  <img src="/images/changelog/REL26-copy.png" alt="Copy from PDFs" className="w-full h-auto my-0" />
</div>
...
<div className="bg-[#FDFDFD] rounded-lg flex items-center justify-center overflow-hidden outline-[0.5px] outline outline-black/10">
  <img src="/images/changelog/REL26-improved search.png" alt="Smarter search" className="w-full h-auto my-0" />
</div>
