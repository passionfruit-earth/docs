...
Filter evidence and answers by adding specific items to your search configuration. For example, filter to only show items that have a particular entity assigned to them, keeping your results focused and relevant.
...
<div className="outline-[0.5px] outline outline-black/10 rounded-lg bg-[#F8F7F4] overflow-hidden my-0">![Reasoning](/images/changelog/REL24-reasoning.png)</div>
...
<div className="outline-[0.5px] outline outline-black/10 rounded-lg bg-[#F8F7F4]">![Redesigned Home Page](images/changelog/REL23-browser_extension-no_bg.png)</div>
...
![Enhanced PDF Experience](images/changelog/REL21-enhanced-pdf-experience.png)
