...
Addresses, VAT numbers, codes, and other company details live in one place and are organized by company or subsidiary. When you search, Passionfruit shows the right information for the one you’re working with and keeps answers and evidence scoped to it—so you never mix information between them.
...
- **Search** — Search is better at finding the right information on the first try. When you filter by entities only, evidence and answers are included by default so results stay relevant.
