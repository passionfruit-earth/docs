...
Connect SharePoint to Passionfruit and your policies, reports, and other documents are automatically pulled into your Knowledge Base. No more downloading, re-uploading, or guessing whether you have the latest version.
...
<div className="bg-[#FDFDFD] rounded-lg flex items-center justify-center overflow-hidden outline-[0.5px] outline outline-black/10">
  <img
    src="/images/changelog/REL28-Sharepoint.png"
    alt="Integrate evidence from SharePoint"
    className="w-full h-auto my-0"
  />
</div>

[Read more about the SharePoint integration](/docs/sharepoint)
...
<div className="bg-[#FDFDFD] rounded-lg flex items-center justify-center overflow-hidden outline-[0.5px] outline outline-black/10">
  <img
    ...
    alt="Evidence version history showing document changes over time"
    className="w-full h-auto my-0"
  />
</div>

[Read more about evidence versioning](/docs/knowledge-base/evidence-versions)

#### Reviewing approved answers

When source evidence changes, approved answers that were generated from that evidence are automatically moved to **To review**. Your team gets a clear signal that something changed and certain responses may need updating.
...
Answer reuse is now more direct, duplicate evidence is easier to catch, and new uploads are easier to organize.

#### Select sources for search

You can choose **which** parts of your knowledge base are searched each time you fill a questionnaire. In **Select sources**, turn **Entity**, **Answer library**, and **Evidence** on or off so you only search where you need (for example, evidence only, or answers only). The setting applies to **the whole questionnaire session**: once you choose it, **every question** in that chat uses the same source mix until you change it.
...
[Read more about search configuration](/docs/fill-questionnaires/search-configuration)

#### Matching answers

When Passionfruit finds a matching answer, it now returns that Answer Library entry directly, including your colleague's comment so you can quickly confirm why it's the best fit.

<div className="bg-[#FDFDFD] rounded-lg flex items-center justify-center overflow-hidden outline-[0.5px] outline outline-black/10">
  <img
    src="/images/changelog/REL27-answer-library-match.png"
    alt="Answer Library match with colleague context"
    className="w-full h-auto my-0"
  />
</div>

[Read more about how answers are generated](/docs/fill-questionnaires/generate-answers)

#### Duplicate evidence detection

Passionfruit now detects duplicate evidence during upload and flags files that already exist before they are added, helping keep your knowledge base clean and reducing redundant evidence.

<div className="bg-[#FDFDFD] rounded-lg flex items-center justify-center overflow-hidden outline-[0.5px] outline outline-black/10">
  <img
    src="/images/changelog/REL27-evidence%20duplication.png"
    alt="Duplicate evidence detection on upload"
    className="w-full h-auto my-0"
  />
</div>

[Read more about uploading evidence](/docs/knowledge-base/evidence-upload)

#### Assign properties on upload

You can now assign key properties during upload by selecting the right entity and adding important tags in one step. Those properties are applied immediately, so evidence is organized from the start.
...
[Read more about upload properties and tagging](/docs/knowledge-base/evidence-upload)

### Improvements & bug fixes

- Improved user interface for better usability and accessibility
- Better handling of overview questions and multi-question prompts
- Clearer evidence and source previews during review
- More reliable PDF viewing and text selection
- Fixes for upload, restore, and display issues across the app
...
Work within the right context. You can now limit your search scope to one or more specific entities. Once selected, only the library answers and evidence linked to those entities are considered. This keeps your results focused and avoids noise from other sites, business units, or suppliers.
...
PDFs come in all shapes and quality levels, which made copying text unreliable. That's fixed—you can now select and copy text from PDFs straight into Passionfruit, regardless of the document quality. Selection and copy work reliably, stay visible, and no longer misalign.

<div className="bg-[#FDFDFD] rounded-lg flex items-center justify-center overflow-hidden outline-[0.5px] outline outline-black/10">
  <img
    src="/images/changelog/REL26-copy.png"
    alt="Copy from PDFs"
    className="w-full h-auto my-0"
  />
</div>
...
Search results across your Answer Library and evidence are more accurate and relevant. The right information surfaces faster, whether it's a reusable answer, a policy document, or a specific data point buried in your files. When you filter by entities only, evidence and answers are included by default so results stay focused.

<div className="bg-[#FDFDFD] rounded-lg flex items-center justify-center overflow-hidden outline-[0.5px] outline outline-black/10">
  <img
    src="/images/changelog/REL26-improved-search.png"
    alt="Smarter search"
    className="w-full h-auto my-0"
  />
</div>
